...
if (count($_POST) > 0 && $_POST["persistform"] != "1") {
	...
	//get the HTTP values and set as variables
		...
		$level = check_str($_POST["user_level"]);
...
//show the content
	...
	if ((permission_exists("user_add") && $action == 'add') || (permission_exists("user_edit") && $action == 'edit')) {
		...
		echo "</td>\n";
		echo "<td class='vtable' align='left'>\n";
		echo "	<select class='formfld' name='user_level'>\n";
		echo "		<option value='admin'>Admin</option>\n";
		echo "		<option value='superadmin' ".(($level == "superadmin") ? "selected='selected'" : null).">Superadmin</option>\n";
		echo "		<option value='manager' ".(($level == "manager") ? "selected='selected'" : null).">Manager</option>\n";
		echo "		<option value='leader' ".(($level == "leader") ? "selected='selected'" : null).">Leader</option>\n";
		echo "		<option value='user' ".(($level == "user") ? "selected='selected'" : null).">User</option>\n";
		echo "		<option value='agent' ".(($level == "agent") ? "selected='selected'" : null).">Agent</option>\n";
		echo "	</select>\n";
		echo "<br />\n";
		echo $text['description-enabled']."\n";
		echo "</td>\n";
