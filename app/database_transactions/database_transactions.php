...
if (!isset($start_stamp_begin) || $start_stamp_begin == "") {    $start_stamp_begin = date("Y-m-d ")." 00:00";}
else{    $start_stamp_begin = $start_stamp_begin;}
if (!isset($start_stamp_end) || $start_stamp_end == "") {    $start_stamp_end = date("Y-m-d ")." 23:59";}
else{    $start_stamp_end = $start_stamp_end;}
//add the search term
	...
	$sql_search .= " and (transaction_date BETWEEN '".$start_stamp_begin."' and  '".$start_stamp_end."') ";
//additional includes
...
//prepare to page the results
	...
	$sql .= "AND (app_name != 'call_recordings' AND transaction_type != 'add')";
	$sql .= $sql_search;
...
//get the list
	...
	$sql .= "AND (t.app_name != 'call_recordings')";
	$sql .= $sql_search;
...
// 	<tr>
// 	<td class="vncell" valign="top" nowrap="nowrap">
// 		Start Range
// 	</td>
// 	<td class="vtable" align="left" style="position: relative; min-width: 250px;">
// 		<input type="text" class="formfld datetimepicker" style="min-width: 115px; width: 115px;" name="from" value="">
// 		<input type="text" class="formfld datetimepicker" style="min-width: 115px; width: 115px;" name="start_stamp_end" placeholder="To" value="2022-01-06 23:59">
// 	</td>
// </tr>
//show the content
	...
	echo "			<input type='text' class='formfld datetimepicker' style='min-width: 115px; width: 115px;' name='start_stamp_begin' placeholder='From' value='".escape($start_stamp_begin)."'>\n";
	echo "			<input type='text' class='formfld datetimepicker' style='min-width: 115px; width: 115px;' name='start_stamp_end' placeholder='To' value='".escape($start_stamp_end)."'>\n";
	echo "		</td>\n";
