...
//debug true
	...
	function PostToAPIES($uuid, $xml)
	{
		$apiUrl = "https://api-pbx01.tel4vn.com/v1/cdr/queue";
		ignore_user_abort(true);
		$ch = curl_init();
		curl_setopt_array($ch, array(
			CURLOPT_URL => $apiUrl . "?uuid=$uuid",
			CURLOPT_POST => true,
		...
		$out = curl_exec($ch);
		curl_close($ch);
		file_put_contents("API_CDR.log", "xml_cdr_uuid : $uuid \n", FILE_APPEND);
		//file_put_contents("API_CDR_XML.log", "$xml \n", FILE_APPEND);
		return true;
	}
?>
