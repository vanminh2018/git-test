...
//show the results
	...
	echo "		<th style='text-align: right;'>".$text['label-duration-call']."</th>\n";
	...
	if (isset($summary)) foreach ($summary as $key => $row) {
		...
		echo "	<td valign='top' class='".$row_style[$c]."' style='text-align: right;'>".(($row['outbound_duration'] != '') ? convert_seconds($row['outbound_duration']) : '0:00:00')."</td>\n";
		echo "	<td valign='top' class='".$row_style[$c]."' style='text-align: right;'>".escape($row['call_time'])."&nbsp;</td>\n";
