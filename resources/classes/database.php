			...
			public function delete($array) {
				...
				//log the transaction results
					if (file_exists($_SERVER["PROJECT_ROOT"]."/app/database_transactions/app_config.php")) {
						// Start don't save transaction
						if($this->app_name == 'call_recordings') {
							return;
						}
						// End don't save transaction
							...
							//add a record
								if ($action == "add") {
									...
									if (permission_exists($this->singular($this->name).'_add')) {
											// Start don't save v_call_recordings
											if ($this->name == "call_recordings") {
												return;
											}
											// End dont'save v_call_recording
											$params = array();
