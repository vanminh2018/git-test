...
<body onload="<?php echo $onload;?>">
	...
	if (strlen($_SESSION["username"]) > 0 && permission_exists("domain_select") && count($_SESSION['domains']) > 1) {
		...
		<div id="domains_container">
			...
			<div id="domains_block">
				...
				<div id="domains_list">
					<?php
					$bgcolor1 = 'images/background.jpg';
					$bgcolor2 = 'images/background.jpg';
					foreach($_SESSION['domains'] as $domain) {
						$bgcolor = ($bgcolor == $bgcolor1) ? $bgcolor2 : $bgcolor1;
						$bgcolor = ($domain['domain_uuid'] == $_SESSION['domain_uuid']) ? "#eeffee" : $bgcolor;
						echo "<div id=\"".escape($domain['domain_name'])."\" class='domains_list_item' style='background-image: url(".$bgcolor.")' onclick=\"document.location.href='".PROJECT_PATH."/core/domain_settings/domains.php?domain_uuid=".escape($domain['domain_uuid'])."&domain_change=true';\">";
	...
	if (!$default_login) {
		...
		//determine menu configuration
			...
			<div id='footer'>
				<span class='footer'><?php echo (isset($_SESSION['theme']['footer']['text'])) ? $_SESSION['theme']['footer']['text'] : "&copy; ".$text['theme-label-copyright']." 2008 - ".date("Y")." <a href='https://tel4vn.edu.vn' class='footer' target='_blank'>https://tel4vn.edu.vn</a> ".$text['theme-label-all_rights_reserved']; ?></span>
			</div>
		</div>
